...
export const COLLECTIONS: CollectionDefinition[] = [
  ...
  { slug: "bots-automations", name: "Bots & Automations", description: "Discord bots, workflow automations, integrations, and systems that keep work moving.", accent: "from-emerald-500 to-cyan-500", keywords: ["discord", "bot", "automation", "workflow", "integration", "zapier", "make", "n8n", "slack"] },
