...
export const metadata = {
  title: "How to buy and sell digital products on Vennet",
  description: "Learn how to browse digital tools, buy templates and downloads, and set up a creator storefront on Vennet.",
};
