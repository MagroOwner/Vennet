...
export default async function ListingPage({ params }: { params: { id: string } }) {
  ...
  const listingDetails = listing as typeof listing & { previewUrl?: string | null; licenseType?: string | null; deliveryTime?: string | null; tags?: string[] | null; collection?: string | null; fileType?: string | null; compatibility?: string | null; includesUpdates?: boolean | null; updatePolicy?: string | null };
